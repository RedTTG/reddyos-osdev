...
.loop:
    ...
    or eax, 0b10000011; present, writable, and 2 MiB page
    mov [page_table_l2 + ecx * 8], eax ; set page table entry
...
enable_paging:
    ; pass the address of the page table to the cpu
